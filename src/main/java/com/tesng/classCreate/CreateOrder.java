...
public class CreateOrder  extends BaseClass{
	...
	@Test
	public void runCreateOrder() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@title='Search Contracts']")).sendKeys("00000104");
		Thread.sleep(2000);
	...
	driver.findElement(By.xpath("//div[text()='Testleaf Software']")).click();
		...
		selectDayMonthYear("NOVEMBER","2019","15");
	...
	public  void selectDayMonthYear(String month,String year,String day) {
		//handling calender
		//year
